...
public class PanelCadastrarCarona extends Composite {
	...
	public PanelCadastrarCarona(final InfoCaronaServerAsync controller, final String idUsuario) {
		...
		final TextBox boxOrigem = new TextBox();
		...
		hPanel01.setCellVerticalAlignment(labelOrigem,
				HasVerticalAlignment.ALIGN_MIDDLE);
		hPanel01.setCellHorizontalAlignment(labelOrigem,
				HasHorizontalAlignment.ALIGN_LEFT);
		hPanel01.setCellVerticalAlignment(boxOrigem,
				HasVerticalAlignment.ALIGN_MIDDLE);
		hPanel01.setCellHorizontalAlignment(boxOrigem,
		...
		final TextBox boxDestino = new TextBox();
		...
		hPanel02.setCellVerticalAlignment(labelDestino,
				HasVerticalAlignment.ALIGN_MIDDLE);
		hPanel02.setCellHorizontalAlignment(labelDestino,
				HasHorizontalAlignment.ALIGN_LEFT);
		hPanel02.setCellVerticalAlignment(boxDestino,
				HasVerticalAlignment.ALIGN_MIDDLE);
		hPanel02.setCellHorizontalAlignment(boxDestino,
				HasHorizontalAlignment.ALIGN_RIGHT);
		vPanel.add(hPanel02);
		...
		final DateBox boxDataCarona = new DateBox();
		boxDataCarona.setFormat(new DateBox.DefaultFormat(
		...
		hPanel03.setCellVerticalAlignment(labelData,
				HasVerticalAlignment.ALIGN_MIDDLE);
		hPanel03.setCellHorizontalAlignment(labelData,
				HasHorizontalAlignment.ALIGN_LEFT);
		hPanel03.setCellVerticalAlignment(boxDataCarona,
				HasVerticalAlignment.ALIGN_MIDDLE);
		hPanel03.setCellHorizontalAlignment(boxDataCarona,
				HasHorizontalAlignment.ALIGN_RIGHT);
		vPanel.add(hPanel03);
		...
		final ListBox listBoxVagas = new ListBox();
		for (int i = 1; i < 10; i++) {
		...
		hPanel04.setCellVerticalAlignment(labelHora,
				HasVerticalAlignment.ALIGN_MIDDLE);
		hPanel04.setCellHorizontalAlignment(labelHora,
				HasHorizontalAlignment.ALIGN_LEFT);
		hPanel04.setCellVerticalAlignment(boxHora,
				HasVerticalAlignment.ALIGN_MIDDLE);
		hPanel04.setCellHorizontalAlignment(boxHora,
				HasHorizontalAlignment.ALIGN_RIGHT);
		hPanel04.setCellVerticalAlignment(labelVagas,
				HasVerticalAlignment.ALIGN_MIDDLE);
		hPanel04.setCellHorizontalAlignment(labelVagas,
				HasHorizontalAlignment.ALIGN_RIGHT);
		hPanel04.setCellVerticalAlignment(listBoxVagas,
				HasVerticalAlignment.ALIGN_MIDDLE);
		hPanel04.setCellHorizontalAlignment(listBoxVagas,
				HasHorizontalAlignment.ALIGN_RIGHT);
		vPanel.add(hPanel04);
		// segunda linha
		...
		// carona municipal
		final DisclosurePanel disclousureCaronaMunicipal = new DisclosurePanel(
				"Carona Municipal");
		HorizontalPanel hPanel05 = new HorizontalPanel();
		Label labelCidade = new Label("Cidade:");
		final TextBox boxCidade = new TextBox();
		...
		hPanel05.setCellHorizontalAlignment(labelCidade,
				HasHorizontalAlignment.ALIGN_LEFT);
		hPanel05.setCellVerticalAlignment(labelCidade,
				HasVerticalAlignment.ALIGN_MIDDLE);
		hPanel05.setCellHorizontalAlignment(boxCidade,
				HasHorizontalAlignment.ALIGN_RIGHT);
		hPanel05.setCellVerticalAlignment(boxCidade,
				HasVerticalAlignment.ALIGN_MIDDLE);
		...
		botaoCadastrarCarona.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				if (disclousureCaronaMunicipal.isOpen()) {
					controller.cadastrarCaronaMunicipal(idUsuario, boxOrigem.getText(),boxDestino.getText(), boxCidade.getText(), boxDataCarona.getTextBox().getText(), boxHora.getText(),listBoxVagas.getSelectedIndex()+1 + "",new AsyncCallback<String>() {

						public void onSuccess(String result) {
							boxOrigem.setText("");
							boxDestino.setText("");
							boxCidade.setText("");
							boxDataCarona.getTextBox().setText("");
							boxHora.setText("");
							boxCidade.setText("");
					...
					controller.cadastrarCarona(idUsuario, boxOrigem.getText(),boxDestino.getText(), boxDataCarona.getTextBox().getText(), boxHora.getText(),listBoxVagas.getSelectedIndex()+1 + "",new AsyncCallback<String>() {
		...
		vPanel.setCellHorizontalAlignment(botaoCadastrarCarona,
		...
		hPanelCadastroCarona.setCellHorizontalAlignment(vPanel,
				HasHorizontalAlignment.ALIGN_LEFT);
