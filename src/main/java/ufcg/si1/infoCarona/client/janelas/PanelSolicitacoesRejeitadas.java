...
public class PanelSolicitacoesRejeitadas extends Composite {
	...
	public PanelSolicitacoesRejeitadas(final InfoCaronaServerAsync controller,
		...
		panelSolicitacoesRejeitadas.add(tabelaSolicitacoes);
		panelSolicitacoesRejeitadas.add(pager);

		panelSolicitacoesRejeitadas.setCellHorizontalAlignment(
				tabelaSolicitacoes, HasHorizontalAlignment.ALIGN_CENTER);
		panelSolicitacoesRejeitadas.setCellHorizontalAlignment(pager,
				HasHorizontalAlignment.ALIGN_CENTER);
		panelSolicitacoesRejeitadas.setSpacing(8);

		initWidget(panelSolicitacoesRejeitadas);
