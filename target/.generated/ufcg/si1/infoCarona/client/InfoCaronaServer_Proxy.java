...
public class InfoCaronaServer_Proxy extends RemoteServiceProxy implements ufcg.si1.infoCarona.client.InfoCaronaServerAsync {
  private static final String REMOTE_SERVICE_INTERFACE_NAME = "ufcg.si1.infoCarona.client.InfoCaronaServer";
  private static final String SERIALIZATION_POLICY ="B60A7A60CB4D8EF5495B55607FF5BBA4";
  private static final ufcg.si1.infoCarona.client.InfoCaronaServer_TypeSerializer SERIALIZER = new ufcg.si1.infoCarona.client.InfoCaronaServer_TypeSerializer();
  ...
  public void aceitarSolicitacaoPontoEncontro(java.lang.String idSessao, java.lang.String idCarona, java.lang.String idSugestao, java.lang.String pontos, com.google.gwt.user.client.rpc.AsyncCallback retorno) {
    com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper helper = new com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper("InfoCaronaServer_Proxy", "aceitarSolicitacaoPontoEncontro");
    try {
  ...
  public void confirmarSolicitacaoUsuario(java.lang.String idSessao, java.lang.String idSolicitacao, com.google.gwt.user.client.rpc.AsyncCallback retorno) {
    com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper helper = new com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper("InfoCaronaServer_Proxy", "confirmarSolicitacaoUsuario");
    try {
      SerializationStreamWriter streamWriter = helper.start(REMOTE_SERVICE_INTERFACE_NAME, 2);
      streamWriter.writeString("java.lang.String/2004016611");
      streamWriter.writeString("java.lang.String/2004016611");
      streamWriter.writeString(idSessao);
      streamWriter.writeString(idSolicitacao);
      helper.finish(retorno, ResponseReader.STRING);
    } catch (SerializationException ex) {
      retorno.onFailure(ex);
    }
  ...
  public void getListaSolicitacoesPendentesCarona(java.lang.String idCarona, com.google.gwt.user.client.rpc.AsyncCallback retorno) {
    com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper helper = new com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper("InfoCaronaServer_Proxy", "getListaSolicitacoesPendentesCarona");
    try {
      SerializationStreamWriter streamWriter = helper.start(REMOTE_SERVICE_INTERFACE_NAME, 1);
      streamWriter.writeString("java.lang.String/2004016611");
      streamWriter.writeString(idCarona);
  ...
  public void getListaSugestaoPontoEncontro(java.lang.String idCarona, com.google.gwt.user.client.rpc.AsyncCallback retorno) {
    com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper helper = new com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper("InfoCaronaServer_Proxy", "getListaSugestaoPontoEncontro");
    try {
      SerializationStreamWriter streamWriter = helper.start(REMOTE_SERVICE_INTERFACE_NAME, 1);
      streamWriter.writeString("java.lang.String/2004016611");
      streamWriter.writeString(idCarona);
  ...
  public void recusarSolicitacaoUsuario(java.lang.String idSessao, java.lang.String idSolicitacao, com.google.gwt.user.client.rpc.AsyncCallback retorno) {
    com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper helper = new com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper("InfoCaronaServer_Proxy", "recusarSolicitacaoUsuario");
    try {
      SerializationStreamWriter streamWriter = helper.start(REMOTE_SERVICE_INTERFACE_NAME, 2);
      streamWriter.writeString("java.lang.String/2004016611");
      streamWriter.writeString("java.lang.String/2004016611");
